...
$$.Bound_setCanvasSize_Doodle = {"": "BoundClosure;_self,_liblib$_target,_receiver",
  call$1: function(p0) {
    return this._self[this._liblib$_target](p0);
  },
  call$0: function() {
...
JSArray: {"": "List/Interceptor;",
  ...
  getRange$2: function(receiver, start, end) {
    ...
    return $.SubListIterable$(receiver, start, end);
  },
...
["doodle.dart", "doodle.dart", , {
main: function() {
  var canvas, doodle, t1;
  ...
  new $._EventStreamSubscription(0, t1._target, t1._eventType, doodle.get$touchStart(), t1._useCapture)._tryResume$0();
  canvas.get$onTouchMove;
  $.EventStreamProvider_touchmove.forTarget$2$useCapture;
  t1 = new $._EventStream(canvas, $.EventStreamProvider_touchmove._eventType, false);
  new $._EventStreamSubscription(0, t1._target, t1._eventType, doodle.get$touchMove(), t1._useCapture)._tryResume$0();
  ...
  new $._EventStreamSubscription(0, t1._target, t1._eventType, doodle.get$touchEnd(), t1._useCapture)._tryResume$0();
  canvas.get$onTouchCancel;
  $.EventStreamProvider_touchcancel.forTarget$2$useCapture;
  t1 = new $._EventStream(canvas, $.EventStreamProvider_touchcancel._eventType, false);
  new $._EventStreamSubscription(0, t1._target, t1._eventType, doodle.get$touchCancel(), t1._useCapture)._tryResume$0();
  ...
  new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.main_closure(doodle), t1._useCapture)._tryResume$0();
},
...
Doodle: {"": "Object;canvas>,ctx<,lastX@,lastY@,nextX@,nextY@,draw?,subscription?,dataModel<",
  ...
  begin$0: function() {
    ...
    new $._EventStreamSubscription(0, t1._target, t1._eventType, this.get$setCanvasSize(), t1._useCapture)._tryResume$0();
    t1 = this.canvas;
    t1.get$onMouseDown;
    $.EventStreamProvider_mousedown.forTarget$2$useCapture;
    t1 = new $._EventStream(t1, $.EventStreamProvider_mousedown._eventType, false);
    new $._EventStreamSubscription(0, t1._target, t1._eventType, new $.Doodle_begin_closure(this), t1._useCapture)._tryResume$0();
  },
...
Doodle_begin_closure: {"": "Closure;this_0",
  call$1: function(e) {
    ...
    t3 = new $._EventStreamSubscription(0, t3._target, t3._eventType, t2.get$mouseMoveCallback(), t3._useCapture);
    t3._tryResume$0();
    t2.set$subscription(t3);
    t1 = t1.get$canvas(t2);
    t1.get$onMouseUp;
    $.EventStreamProvider_mouseup.forTarget$2$useCapture;
    t1 = new $._EventStream(t1, $.EventStreamProvider_mouseup._eventType, false);
    new $._EventStreamSubscription(0, t1._target, t1._eventType, t2.get$mouseUpCallback(), t1._useCapture)._tryResume$0();
    t2.set$draw(true);
    t1 = t2.get$dataModel().paths;
    t3 = t2.get$lastX();
    t4 = t2.get$lastY();
    t5 = t2.get$nextX();
    t6 = t2.get$nextY();
    ...
    $.add$1$ax(t1, new $.PathData(t3, t4, t5, t6, t7.get$strokeStyle(t2), t7.get$lineWidth(t2), true));
  }
},
...
// Native classes
$.defineNativeMethods("CanvasGradient|CanvasPattern|CustomElementConstructor|DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SQLException|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList", $.Interceptor);
...
$.defineNativeMethods("Document|HTMLDocument", $.Document);
...
//@ sourceMappingURL=doodle.dart.js.map
