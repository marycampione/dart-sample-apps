...
UIEvent: {"": "Event;",
  get$layer: function(receiver) {
    return new $.Point(receiver.layerX, receiver.layerY);
  }
},
...
main: function() {
  var doodle, t1, t2;
  doodle = $.Doodle$(document.querySelector("canvas"));
  doodle.begin$0();
  t1 = document.querySelector("#undo-last-doodle");
  t1.get$onClick;
  $.EventStreamProvider_click.forTarget$2$useCapture;
  t1 = new $._EventStream(t1, $.EventStreamProvider_click._eventType, false);
  $.setRuntimeTypeInfo(t1, [null]);
  t2 = new $._EventStreamSubscription(0, t1._liblib5$_target, t1._eventType, new $.main_closure0(doodle), t1._useCapture);
...
Doodle: {"": "Object;canvas,ctx,lastX<,lastY<,nextX<,nextY<,draw,subscription,dataModel",
  ...
  begin$0: function() {
    ...
    t2.get$onMouseDown;
    $.EventStreamProvider_mousedown.forTarget$2$useCapture;
    t1 = new $._EventStream(t2, $.EventStreamProvider_mousedown._eventType, false);
    $.setRuntimeTypeInfo(t1, [null]);
    t3 = this.get$mouseClickCallback();
    t3 = new $._EventStreamSubscription(0, t1._liblib5$_target, t1._eventType, t3, t1._useCapture);
    $.setRuntimeTypeInfo(t3, [$.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t3._tryResume$0();
    t2.get$onTouchStart;
    $.EventStreamProvider_touchstart.forTarget$2$useCapture;
    t2 = new $._EventStream(t2, $.EventStreamProvider_touchstart._eventType, false);
    $.setRuntimeTypeInfo(t2, [null]);
    t3 = this.get$touchStart();
    t3 = new $._EventStreamSubscription(0, t2._liblib5$_target, t2._eventType, t3, t2._useCapture);
    $.setRuntimeTypeInfo(t3, [$.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t3._tryResume$0();
  },
  mouseClickCallback$1: function(e) {
    var t1, t2, t3, t4, t5, t6, t7;
    t1 = $.getInterceptor$x(e);
    t1.preventDefault$0(e);
    t1.stopPropagation$0(e);
    t2 = t1.get$client(e);
    t2 = this.windowToCanvas$1(t2.get$x(t2));
    this.nextX = t2;
    this.lastX = t2;
    t1 = t1.get$client(e);
    t1 = this.windowToCanvas$1(t1.get$y(t1));
    this.nextY = t1;
    this.lastY = t1;
    t1 = this.canvas;
    t1.get$onMouseMove;
    $.EventStreamProvider_mousemove.forTarget$2$useCapture;
    t2 = new $._EventStream(t1, $.EventStreamProvider_mousemove._eventType, false);
    $.setRuntimeTypeInfo(t2, [null]);
    t3 = this.get$mouseMoveCallback();
    t3 = new $._EventStreamSubscription(0, t2._liblib5$_target, t2._eventType, t3, t2._useCapture);
    $.setRuntimeTypeInfo(t3, [$.getRuntimeTypeArgument(t2, "_EventStream", 0)]);
    t3._tryResume$0();
    ...
    $.setRuntimeTypeInfo(t1, [null]);
    t3 = this.get$mouseUpCallback();
    t3 = new $._EventStreamSubscription(0, t1._liblib5$_target, t1._eventType, t3, t1._useCapture);
    $.setRuntimeTypeInfo(t3, [$.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t3._tryResume$0();
    this.draw = true;
    t3 = this.dataModel.paths;
    t1 = this.lastX;
    t2 = this.lastY;
    t4 = this.nextX;
    t5 = this.nextY;
    ...
    $.add$1$ax(t3, new $.PathData(t1, t2, t4, t5, t7.get$strokeStyle(t6), t7.get$lineWidth(t6), true));
  },
  get$mouseClickCallback: function() {
    return new $.BoundClosure$1(this, "mouseClickCallback$1", null);
  },
  touchStart$1: function(e) {
    var t1, t2, t3, t4, t5, t6, t7;
    t1 = $.getInterceptor$x(e);
    t1.preventDefault$0(e);
    t1.stopPropagation$0(e);
    t2 = this.windowToCanvas$1(t1.get$layer(e).x);
    this.nextX = t2;
    this.lastX = t2;
    t1 = this.windowToCanvas$1(t1.get$layer(e).y);
    this.nextY = t1;
    this.lastY = t1;
    t1 = this.canvas;
    t1.get$onTouchMove;
    $.EventStreamProvider_touchmove.forTarget$2$useCapture;
    t2 = new $._EventStream(t1, $.EventStreamProvider_touchmove._eventType, false);
    $.setRuntimeTypeInfo(t2, [null]);
    ...
    t1 = new $._EventStream(t1, $.EventStreamProvider_touchend._eventType, false);
    $.setRuntimeTypeInfo(t1, [null]);
    t3 = this.get$touchEnd();
    t3 = new $._EventStreamSubscription(0, t1._liblib5$_target, t1._eventType, t3, t1._useCapture);
    $.setRuntimeTypeInfo(t3, [$.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t3._tryResume$0();
    this.draw = true;
